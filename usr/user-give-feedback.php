                            ...
                            while ($row = $res->fetch_object()) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required readonly class="form-control"
                                        value="<?php echo $row->u_fname; ?> <?php echo $row->u_lname; ?> "
                                        id="exampleInputEmail1" name="f_uname">
                                </div>
                            <?php } ?>
                            <div class="form-group">
                                <label for="exampleInputEmail1">My Testimonial</label>
                                <textarea type="text" class="form-control" placeholder="Give Your Feedback"
                                    id="exampleInputEmail1" name="f_content"></textarea>
                            </div>
