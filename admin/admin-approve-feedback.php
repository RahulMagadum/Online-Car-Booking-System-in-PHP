                            ...
                            <form method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" required readonly class="form-control"
                                        value="<?php echo $row->f_uname; ?>" id="exampleInputEmail1" name="f_uname">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Client Testimonial</label>
                                    <textarea type="text" class="form-control" readonly placeholder="Give Your Feedback"
                                        id="exampleInputEmail1" name="f_content"><?php echo $row->f_content; ?></textarea>
                                </div>
