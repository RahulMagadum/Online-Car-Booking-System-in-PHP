...
<body id="page-top">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <p>
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()">This code is not for sale. Its sole owner
                    is Code Camp BD For any need you can message me <a href="https://www.facebook.com/dev.mhrony">MH
                        RONY</a> and don't forget to <a href="https://www.youtube.com/@codecampbdofficial">subscribe</a>
                    the youtube channel.</marquee>
            </p>
            <!-- Breadcrumbs-->
            <ol class="breadcrumb">
                    ...
                    while ($row = $res->fetch_object()) {
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" value="Driver"
                                    name="u_category">
                            </div>
            ...
            <div class=" form-group">
                                ...
                                <input type="password" class="form-control" value="<?php echo $row->u_pwd; ?>" name="u_pwd"
